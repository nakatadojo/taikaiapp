  ...
  const competitorRows = competitors.map(c => {
    ...
    return `
      <div style="margin-bottom:14px;padding:14px;background:rgba(124,58,237,0.08);border:1px solid rgba(124,58,237,0.2);border-radius:10px;">
        ...
        <p style="color:#111111;font-size:14px;margin:10px 0 0;font-weight:600;">Subtotal: $${c.subtotal.toFixed(2)}</p>
      </div>
    `;
  }).join('');
...
<body style="margin:0;padding:0;background:#f4f4f5;">
  <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;max-width:560px;margin:0 auto;padding:40px 20px;">
    ...
    <div style="background:#ffffff;border-radius:16px;border-radius:16px;padding:32px;margin-bottom:24px;">
      ...
      <h1 style="color:#111111;font-size:22px;margin:0 0 8px;text-align:center;">Registration Confirmed</h1>
      <p style="color:#555555;font-size:15px;line-height:1.6;margin:0;text-align:center;">
        Your registration for <strong style="color:#111111;">${tournament.name}</strong> is all set.
      </p>
    </div>
    ...
    <div style="background:#ffffff;box-shadow:0 1px 6px rgba(0,0,0,0.06);border-radius:14px;padding:24px;margin-bottom:24px;">
      ...
      <div style="border-top:1px solid rgba(255,255,255,0.08);margin-top:16px;padding-top:16px;">
        ${discountLine}
        <p style="color:#111111;font-size:20px;font-weight:700;margin:4px 0 0;">Total Paid: $${totalPaid.toFixed(2)}</p>
        <p style="color:#888888;font-size:12px;margin:8px 0 0;">Transaction ID: ${transactionId}</p>
      </div>
    </div>
