...
<body style="margin:0;padding:0;background:#0f0f12;">
  <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;max-width:560px;margin:0 auto;padding:40px 20px;">
    ...
    <div style="background:#1a1a24;border:1px solid rgba(124,58,237,0.25);border-radius:16px;padding:32px;margin-bottom:24px;">
      ...
      <h1 style="color:#f9fafb;font-size:22px;margin:0 0 12px;text-align:center;">You're Approved!</h1>
      <p style="color:#9ca3af;font-size:15px;line-height:1.6;margin:0;text-align:center;">
        Hi <strong style="color:#e5e7eb;">${applicantName}</strong>, your application as
        <strong style="color:#22c55e;">${roleLabel}</strong>
        for <strong style="color:#e5e7eb;">${tournamentName}</strong> has been approved.
      </p>
    </div>
