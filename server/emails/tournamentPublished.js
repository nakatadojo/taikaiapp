...
<body style="margin:0;padding:0;background:#f4f4f5;">
  <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;max-width:560px;margin:0 auto;padding:40px 20px;">
    ...
    <div style="background:#ffffff;border-radius:16px;border-radius:16px;padding:32px;margin-bottom:24px;">
      ...
      <h1 style="color:#111111;font-size:22px;margin:0 0 8px;text-align:center;">Your Tournament Is Live!</h1>
      <p style="color:#555555;font-size:15px;line-height:1.6;margin:0;text-align:center;">
        <strong style="color:#111111;">${tournament.name}</strong> is now published and accepting registrations.
      </p>
    </div>

    <!-- Tournament Details -->
    <div style="background:#ffffff;box-shadow:0 1px 6px rgba(0,0,0,0.06);border-radius:14px;padding:20px 24px;margin-bottom:24px;">
      <table style="width:100%;border-collapse:collapse;">
        <tr>
          <td style="color:#555555;font-size:13px;padding:6px 0;">Tournament</td>
          <td style="color:#111111;font-size:14px;text-align:right;padding:6px 0;font-weight:600;">${tournament.name}</td>
        </tr>
        <tr>
          <td style="color:#555555;font-size:13px;padding:6px 0;">Date</td>
          <td style="color:#111111;font-size:14px;text-align:right;padding:6px 0;">${tournamentDate}</td>
        </tr>
        <tr>
          <td style="color:#555555;font-size:13px;padding:6px 0;">Location</td>
          <td style="color:#111111;font-size:14px;text-align:right;padding:6px 0;">${tournament.location || 'TBD'}</td>
        </tr>
      </table>
    </div>
    ...
    <div style="text-align:center;margin-bottom:16px;">
      <a href="${publicUrl}" style="display:inline-block;padding:14px 40px;background:#cc0000;color:#ffffff;text-decoration:none;border-radius:10px;font-weight:600;font-size:15px;">View Public Page</a>
    </div>

    <!-- Share prompt -->
    <div style="background:#ffffff;box-shadow:0 1px 6px rgba(0,0,0,0.06);border-radius:14px;padding:20px 24px;margin-bottom:24px;">
      <h2 style="color:#f3f4f6;font-size:15px;margin:0 0 8px;font-weight:600;">Share your tournament</h2>
      <p style="color:#555555;font-size:13px;line-height:1.6;margin:0 0 12px;">
