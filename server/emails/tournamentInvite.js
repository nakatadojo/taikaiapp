...
<body style="margin:0;padding:0;background:#f4f4f5;">
  <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;max-width:560px;margin:0 auto;padding:40px 20px;">
    ...
    <!-- Header -->
    <div style="background:#ffffff;border:1px solid rgba(220,38,38,0.25);border-radius:16px;padding:32px;margin-bottom:24px;">
      ...
      <h1 style="color:#111111;font-size:22px;margin:0 0 12px;text-align:center;">You're Invited!</h1>
      <p style="color:#555555;font-size:15px;line-height:1.6;margin:0;text-align:center;">
        <strong style="color:#111111;">${inviterName}</strong> has invited you to join
        <strong style="color:#111111;">${tournamentName}</strong> as a
        <strong style="color:#60a5fa;">${roleLabel}</strong>.
      </p>
      <p style="color:#888888;font-size:14px;line-height:1.5;margin:16px 0 0;text-align:center;">
        ${actionText}
      </p>
    </div>
